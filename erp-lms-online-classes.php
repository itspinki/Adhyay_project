...
<body>
				...
				<div class="col-lg-5 col-md-5 col-12 d-flex align-items-center">
					<div class="lms-content">
						<div class="section-title">
							...
							<p>ERP consists of amazing features such as analysis of the entire school/institute data in one click. Admin can review all the activities on our ERP system by clicking on the data links and easily acces the complete management flow.  </p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 col-md-5 col-12 order-1 d-flex align-items-center">
					<div class="lms-content">
						<div class="section-title">
							<h2>Online <span class="highlighted">ANALYSIS & REPORT CARD</span></h2>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 col-md-5 col-12 d-flex align-items-center">
					<div class="lms-content">
						<div class="section-title">
							<h2>Online <span class="highlighted">LEAVE MANAGEMENT</span></h2>
							<p>In the leave section Teachers request leave directly from your device and also send pdf or docs. Admin can be approved in a single click.</p>
							<p>This is a single platform for teachers to easily apply for leave.</p>
						</div>
						<a href="#" class="btn-custom cd-popup-trigger">Book a free demo</a>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 col-md-5 col-12 order-1 d-flex align-items-center">
					<div class="lms-content">
						<div class="section-title">
							<h2>Online <span class="highlighted">FEES MANAGEMENT</span></h2>
							<p>The fees section is the most important part in a School Management ERP. When you can do everything else through the app, wouldn’t it be nice if you could pay the fees also through the app? Online fees payment would be a real icing on the cake when using the school’s very own app. So we have accommodated this use case too, by providing a payment option for the Parents in the app Itself.</p>
							<p>Parents can view & pay fees online from anywhere at anytime<br /> School Management can easily track the fee defaulters or check pending fees in a single click.</p>
						</div>
						<a href="#" class="btn-custom cd-popup-trigger">Book a free demo</a>
					</div>
				</div>
	...
	<section id="box9" class="lms-section section">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-md-7 col-12">
					<div class="lms-figure">
				...
				<div class="col-lg-5 col-md-5 col-12 d-flex align-items-center">
					<div class="lms-content">
						<div class="section-title">
							...
							<p> Students can easily attend the online exam, test series & mock test from their devices.</p>
							<p>Once the examination is scheduled, students will receive an instant notification and at the scheduled time students can appear for the test from their  devices.</p>
						</div>
						<a href="#" class="btn-custom cd-popup-trigger">Book a free demo</a>
					</div>
				</div>
	...
	<section id="box10" class="lms-section section bg-light">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-md-7 col-12 order-2">
					<div class="lms-figure">
				...
				<div class="col-lg-5 col-md-5 col-12 order-1 d-flex align-items-center">
					<div class="lms-content">
						<div class="section-title">
							...
							<p>Create the homework and distribute it to the whole class or a group of particular students.</p>
							<p>Students can submit answers and also view pending and submitted homework, submission details.</p>
							<p> In this platform we can also assign the homework through the pdf , docx, image, video and youtube link. In our software you can work easily and with little time.</p>
						</div>
						<a href="#" class="btn-custom cd-popup-trigger">Book a free demo</a>
					</div>
				</div>
	...
	<section id="box11" class="lms-section section">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-md-7 col-12">
					<div class="lms-figure">
				...
				<div class="col-lg-5 col-md-5 col-12 d-flex align-items-center">
					<div class="lms-content">
						<div class="section-title">
							...
							<p> Create online classes, see the session list. When students enter the class attendance will be automatically submitted in the session list in teacher login.</p>
							<p>This is the single platform for which we easily start an online session through our video conferencing link.</p>
						</div>
						<a href="#" class="btn-custom cd-popup-trigger">Book a free demo</a>
					</div>
				</div>
