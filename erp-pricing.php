	...
	<section class="ecommerce_packages_block margin-top-small">
		...
		<div class="container">
			<div class="section-title text-center">
				<h2>SOFTWARE PRICING  <br /><span class="highlighted">AND FEATURES</span></h2>
			...
			<table id="ecommerce_pack" cellpadding="0" cellspacing="0" class="table_cell_next_2">
				<thead>
					<tr>
						<th>&nbsp; <span> </span></th>
						<th>
							<div class="packtitle">Learning Management System
							<br><small>(LMS)</small></div>
						</th>
						<th class="best-active">
							<div class="packtitle">LMS 
								<br><small></small></div>
						</th>
                        <th class="best-active">
							<div class="packtitle">Video Conferencing
								<br><small></small></div>
						</th>

						<th>
							<div class="packtitle">Enterprise Resource
								<br><small>(Planning )</small></div>
						</th>
						<th>
							<div class="packtitle">LMS + ERP
								</div>
						</th>
						<th>
							<div class="packtitle">LMS + ERP + Video Conferencing
				...
				<tbody>
					...
					<tr>
						<td></td>
						<td>Per/Month = Rs999</td>
						<td><span>Upto 500 students and 1 logins Monthly = Rs 8000</span> </td>
						<td> <span>Upto 1000 students and 50 logins Monthly = Rs 15000 <span></span> </td>
						<td><span>Standard-Rs.9/ Per Student</span></td>
                        <td><span>Rs.13/Student/Month </span></td>

						<td><span>Rs.22/Student/Month</span></td>
					</tr>
					<tr>
						<td></td>
						<td>Quaterly = Rs 2499</td>
						<td><span>Quaterly Rs 24000</span> </td>
						<td><span>Quaterly Rs 45000</span> </td>
						<td><span>Advance-Rs.15/ Per Student</span> </td>
                        <td><span>Rs.19/Student/Month</span> </td>

						<td><span>Rs.34/Student/Month</span> </td>
					</tr>
					<tr>
						<td></td>
						<td>Half/Yearly = Rs 4999</td>
						<td><span>Half Yearly Rs 48000</span></td>
						<td><span>Half Yearly Rs 90000</span></td>
						<td><span>Platinum-Rs.18/ Per Student</span></td>
                        <td><span>Rs.22/Student/Month</span> </td>

						<td><span>Rs.40/Student/Month</span></td>
					</tr>

					<tr>
						<td></td>
						<td>Annually = Rs 9450 </td>
						<td><span>Per Annum = Rs 96000</span></td>
						<td><span>Per Annum = Rs 1,80,000 </span></td>
						<td><span></span></td>
                        <td><span></span> </td>
